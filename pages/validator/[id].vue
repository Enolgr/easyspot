<template>
  <ClientOnly>
    <div class="min-h-screen bg-white">
      <!-- Estado de validación de autorización -->
      ...
      <!-- Contenido principal (solo si está autorizado) -->
      <template v-else>
        <!-- Banner del evento estilo Notion -->
        ...
        <div v-if="!isValidating && isAuthorized" class="max-w-xl mx-auto px-6 py-8">
          ...
          <div v-else>
            ...
            <!-- Cámara con marco estilo Notion -->
            <div class="relative">
              <div class="overflow-hidden rounded-lg border border-gray-200 shadow-sm">
                ...
                <!-- Marco de escaneo estilo Notion -->
            ...
            <!-- Botón de prueba manual (solo para desarrollo) -->
        ...
        <Modal :is-open="showResultModal" title="Resultado de Validación" @close="closeResultModal" class="max-w-lg">
          ...
          <div v-else-if="validationResult" class="p-6">
            <!-- Ticket válido y validado correctamente -->
            ...
            <!-- Ticket ya validado previamente -->
            <div v-else-if="validationResult.status === 'already_validated'" class="text-center">
              ...
              <!-- Información del ticket ya validado -->
...
// Verificar si el usuario es el promotor del evento
const validateEventOwnership = async () => {
  try {
    console.log('Validando propiedad del evento...')
    
    // Verificar que tenemos acceso al route y sus params
    if (!route?.params?.id) {
    ...
    console.log('User UID:', userStore.user?.uid)
    ...
    // La API ya verifica que el usuario es promotor del evento
...
async function onDecode(decoded) {
  console.log('🎯 Código QR detectado:', decoded)
  ...
  try {
    ...
    console.log('📡 Enviando validación para:', decoded)
    ...
    console.log('✅ Resultado de validación:', response)
